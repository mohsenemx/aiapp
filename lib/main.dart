...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      ...
      colorScheme: isDark ? ColorScheme.dark(surface: Color.fromRGBO(2, 17, 17, 1), primary: Color.fromRGBO(35, 83, 71, 1),) : ColorScheme.light(surface: Color.fromRGBO(218, 241, 222, 1))
      ,),
